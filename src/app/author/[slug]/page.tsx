    ...
    export default function GenresSlug() {
    ...
    useEffect(() => {
        ...
        setLoading(true);
        const response = await getAllComics({ page: pageParam, limit: limitComics, author: SLUG });
        setComics(response);
        setLoading(false);
        };
        fetchData();
    ...
    <div className="container pb-20 px-[1%] md:px-0">
        ...
        <div className="">
            ...
            <div className="mb-3 px-2">
                <h1 className="text-2xl font-light">Author: <span className="text-link">{SLUG}</span></h1>
